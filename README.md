...
|           이름           | 역할                                                | 담당 브랜치 |                   GitHub                    |
| :----------------------: | :-------------------------------------------------- | :---------: | :-----------------------------------------: |
| **황시원** <br> _(팀장)_ | 기획 / 디자인 / 레시피 상세 퍼블리싱                |   `siwon`   |   [@isnow-x](https://github.com/isnow-x)    |
|        **김정우**        | 디자인 / 메인 / 레시피 목록 퍼블리싱                |  `Jungwoo`  | [@casperjwk](https://github.com/casperjwk/) |
